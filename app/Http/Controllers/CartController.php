...
class CartController extends Controller
{
    ...
    public function update_cart(Request $request){
     ...
     public function cart_ajax(Request $request){
        ...
        return view('pages.cart.show_cart_ajax')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_title',$meta_title)->with('meta_keywords',$meta_keywords)->with('url_canonical',$url_canonical)->with('slider',$slider);
    }
