                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input data-validation="required" data-validation-length="min10"  type="text" name = "product_name" class="form-control" id="slug" placeholder="Name" onkeyup="ChangeToSlug();"required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Slug</label>
                                    <input type="text" name="product_slug" class="form-control " id="convert_slug" placeholder="category slug" required>
                                </div>
                                <div class="form-group">
